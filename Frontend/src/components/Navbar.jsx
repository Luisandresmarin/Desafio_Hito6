...
const Navbar = () => {
  const { getTotalPrice } = useCart(); // Obtener la función para calcular el total
  const total = getTotalPrice(); // Calcular el total del carrito
  const token = false; // Cambia esto según tu lógica de autenticación
